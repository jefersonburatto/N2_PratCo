...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTABLISHMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESTABLISHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESTABLISHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESTABLISHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESTABLISHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESTABLISHMENT actions', async () => {
      const expectedActions = [
        {
