...
export const EstablishmentDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(establishmentEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="pratcoApp.establishment.delete.question">
        Are you sure you want to delete Establishment {establishmentEntity.id}?
      </ModalBody>
      <ModalFooter>
