...
/**
 * REST controller for managing {@link br.edu.cesusc.pratco.domain.Address}.
 */
@RestController
@RequestMapping("/api")
public class AddressResource {
    ...
    public List<Address> getAllAddresses(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
